...
export {createCategory, getAllCategories, getCategory, updateCategory, deleteCategory, getCategoryMiddleWare}

async function getCategoryMiddleWare(categoryName: string) {
...
const getCategory: RequestHandler = asyncHandler(async (req, res) => {
    ...
    const category = await getCategoryMiddleWare(req.params.categoryName)
